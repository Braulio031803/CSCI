...
df_main = pd.read_csv("game-ratings-by-release-dates.cvs")

df_main["first_release_date"] = pd.to_datetime(df_main["first_releae_date"])
...
df_follow = df_follow.rename(columns = { "follow_count": "toltal_follows" })
